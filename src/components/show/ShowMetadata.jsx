    ...
    <div className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700 mb-4">
      ...
      {previousView && (
        <div className="p-2 border-b border-gray-700">
          <button
            onClick={goBack}
            className="px-3 py-1.5 bg-gray-700 hover:bg-gray-600 text-white rounded text-sm transition-colors font-medium inline-flex items-center gap-1"
          >
            {getBackButtonText()}
          </button>
        </div>
        ...
        <div className="p-4 flex-grow">
          <div className="flex items-start justify-between gap-4 mb-2">
            ...
            {showDetails.vote_average > 0 && (
              <div className="flex flex-col items-center bg-yellow-500/20 border border-yellow-500/50 rounded px-3 py-2">
